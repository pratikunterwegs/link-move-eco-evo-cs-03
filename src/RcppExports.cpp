...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(run_model(popsize, scenario, nItems, p_type, landsize, nClusters, clusterSpread, handling_time, regen_time, tmax, genmax, range_perception, range_move, dispersal, nThreads, mProb, mSize));
    return rcpp_result_gen;
END_RCPP
}
